...
const GHJPresentation: React.FC = () => {
    ...
    // Slide 1: Title (そのまま)
    {
      ...
      content: () => (
        <div className="flex flex-col items-center justify-center h-full">
          <h1 className="text-5xl font-bold mb-4 text-[#ff7e5f]">GREAT HERO'S JOURNEY</h1>
          <h2 className="text-3xl mb-8 text-[#feb47b]">"光の柱"を立てよう</h2>
          <h3 className="text-xl font-bold mb-4">ワークショップ2025年3月30日</h3>
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            <div className="text-center p-4 rounded-lg shadow-md bg-[#ffbe76]/30">
          ...
          <div className="flex flex-col md:flex-row gap-6 flex-1">
            ...
            <div className="flex-1 bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>人々の魂の記憶を呼び覚ます</li>
                <li>銀河ファミリーとしての本質を思い出す</li>
                <li>無限の可能性に目覚める</li>
                <li>大いなる意志と統合する</li>
                <li>愛そのものであることを思い出す</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 flex-1">
            ...
            <div className="flex-1 bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>定期的な上映会の開催</li>
                <li>ワークショップの全国展開</li>
                <li>オンラインコミュニティの形成</li>
                <li>オラクルカードの作成</li>
                <li>銀河ファミリーマッピングの深化</li>
                <li>ヒーリング音楽の制作・配信</li>
                <li>個人の魂の開放をサポートする活動</li>
              </ul>
            </div>
          </div>
          <div className="mt-6 p-4 rounded-lg text-center bg-[#ffbe76]/40">
            ...
            <div className="space-y-4">
              {questions.map((q, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                  <button 
                    className="w-full p-4 text-left font-bold flex justify-between items-center text-[#4a3933]"
    ...
    // Slide 10: Contact Form (そのまま)
    {
      ...
      content: () => (
        <div className="flex flex-col h-full">
          ...
          <p className="mb-6">GHJプロジェクトに興味を持っていただきありがとうございます。ワークショップや上映会についてのご質問、ご参加のお申し込み、コラボレーションのご提案など、お気軽にお問い合わせください。</p>
          <GHJContactForm />
        </div>
      )
    }
  ...
  return (
    <div className="w-full h-screen flex flex-col bg-[#fff9f5] text-[#4a3933]">
      ...
      {/* Navigation controls */}
      <div className="p-4 border-t border-[#ffbe76]/30 flex justify-between items-center">
        <button 
          onClick={prevSlide}
          disabled={currentSlide === 0}
          className={`px-4 py-2 rounded-lg text-white ${currentSlide === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-opacity-80'} bg-[#ff7e5f]`}
        >
          前へ
        </button>
        ...
        <div className="flex gap-2">
          {slides.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-200 ${currentSlide === index ? 'scale-125' : 'scale-100'}`}
              style={{ 
        ...
        <button 
          ...
          className={`px-4 py-2 rounded-lg text-white ${currentSlide === slides.length - 1 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-opacity-80'} bg-[#ff7e5f]`}
        >
          次へ
        </button>
      </div>
